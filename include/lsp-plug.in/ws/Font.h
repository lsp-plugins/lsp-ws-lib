    ...
    namespace ws
    {
        ...
        class Font
        {
            ...
            public:
                ...
                inline bool         is_override_antialiasing() const    { return nFlags & FF_OVERRIDE_ANTIALIASING;  }
                ...
                inline void         set_override_antialiasing(bool a)   { if (a) nFlags |= FF_OVERRIDE_ANTIALIASING; else nFlags &= ~FF_OVERRIDE_ANTIALIASING;    }
